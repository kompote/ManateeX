...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>src/sandbox/ben/cases/Case.cxx at master from kompote/ManateeX - GitHub</title>
...
<meta content="w0J8rc1m8/nmRTK5kH3LGCfgQurQIFGibLV+Nqm4shU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-68d680d89cf702cc67c2ebb0b261548622d05ce3.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Case.cxx'>
            ...
            <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/kompote/ManateeX/blob/master/src/sandbox/ben/cases/Case.cxx" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v15:2786772:kompote/ManateeX:16ea63547f487dd535a21ed2eff30942f2033cdc:f2837eee5d5a2080ef9decf08b9199dc -->
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/sandbox/ben/cases/Case.cxx/">
      ...
      <param NAME="FlashVars" value="id=clippy_865&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1315937721?v5"
             ...
             FlashVars="id=clippy_865&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/sandbox/ben/cases/Case.cxx/" data-permalink-url="/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Case.cxx" data-title="src/sandbox/ben/cases/Case.cxx at master from kompote/ManateeX - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/kompote/ManateeX/edit/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Case.cxx" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  <span>16 lines (11 sloc)</span>
                <span>0.221 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/kompote/ManateeX/raw/master/src/sandbox/ben/cases/Case.cxx" id="raw-url">raw</a></li>
                  <li><a href="/kompote/ManateeX/blame/master/src/sandbox/ben/cases/Case.cxx">blame</a></li>
                <li><a href="/kompote/ManateeX/commits/master/src/sandbox/ben/cases/Case.cxx" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L15" rel="#L15">15</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#include &quot;Case.hxx&quot;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="n">Case</span><span class="o">::</span><span class="n">Case</span><span class="p">()</span> <span class="p">{</span><span class="n">texturePath</span><span class="o">=</span><span class="s">&quot;texture.png&quot;</span><span class="p">;}</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="kt">bool</span> <span class="n">Case</span><span class="o">::</span><span class="n">isConstructible</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC6'>	<span class="k">return</span> <span class="n">constructible</span><span class="p">;</span></div><div class='line' id='LC7'><span class="p">}</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="kt">int</span> <span class="n">Case</span><span class="o">::</span><span class="n">getContent</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC10'>	<span class="k">return</span> <span class="n">content</span><span class="p">;</span></div><div class='line' id='LC11'><span class="p">}</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'><span class="n">string</span> <span class="n">Case</span><span class="o">::</span><span class="n">getTexturePath</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC14'>	<span class="k">return</span> <span class="n">texturePath</span><span class="p">;</span></div><div class='line' id='LC15'><span class="p">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.13776s from fe12.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
