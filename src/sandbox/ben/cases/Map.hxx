...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>src/sandbox/ben/cases/Map.hxx at master from kompote/ManateeX - GitHub</title>
...
<meta content="w0J8rc1m8/nmRTK5kH3LGCfgQurQIFGibLV+Nqm4shU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-68d680d89cf702cc67c2ebb0b261548622d05ce3.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Map.hxx'>
            ...
            <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/kompote/ManateeX/blob/master/src/sandbox/ben/cases/Map.hxx" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v15:2786772:kompote/ManateeX:942e0f22857a9262596902be896d5892698bac10:ed06870b7045c35a8d2fbda336dafaf6 -->
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/sandbox/ben/cases/Map.hxx/">
      ...
      <param NAME="FlashVars" value="id=clippy_2301&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1315928456?v5"
             ...
             FlashVars="id=clippy_2301&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/sandbox/ben/cases/Map.hxx/" data-permalink-url="/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Map.hxx" data-title="src/sandbox/ben/cases/Map.hxx at master from kompote/ManateeX - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/kompote/ManateeX/edit/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Map.hxx" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  <span>18 lines (12 sloc)</span>
                <span>0.192 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/kompote/ManateeX/raw/master/src/sandbox/ben/cases/Map.hxx" id="raw-url">raw</a></li>
                  <li><a href="/kompote/ManateeX/blame/master/src/sandbox/ben/cases/Map.hxx">blame</a></li>
                <li><a href="/kompote/ManateeX/commits/master/src/sandbox/ben/cases/Map.hxx" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L17" rel="#L17">17</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#ifndef MAP_H</span></div><div class='line' id='LC2'><span class="cp">#define MAP_H</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="cp">#include &quot;Case.hxx&quot;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="k">class</span> <span class="nc">Map</span> <span class="p">{</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'>	<span class="k">private</span><span class="o">:</span></div><div class='line' id='LC9'>		<span class="n">Case</span><span class="o">*</span> <span class="n">grid</span><span class="p">[</span><span class="mi">60</span><span class="p">][</span><span class="mi">80</span><span class="p">];</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>	<span class="k">public</span><span class="o">:</span></div><div class='line' id='LC12'>		<span class="n">Map</span><span class="p">();</span></div><div class='line' id='LC13'>		<span class="n">Case</span> <span class="n">getCase</span><span class="p">(</span><span class="kt">int</span> <span class="n">i</span><span class="p">,</span> <span class="kt">int</span> <span class="n">j</span><span class="p">);</span></div><div class='line' id='LC14'>		<span class="n">Case</span> <span class="n">getCasePixel</span><span class="p">(</span><span class="kt">int</span> <span class="n">x</span><span class="p">,</span> <span class="kt">int</span> <span class="n">y</span><span class="p">);</span></div><div class='line' id='LC15'><span class="p">};</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'><span class="cp">#endif</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.08619s from fe11.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
