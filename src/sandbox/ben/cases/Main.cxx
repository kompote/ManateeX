...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>src/sandbox/ben/cases/Main.cxx at master from kompote/ManateeX - GitHub</title>
...
<meta content="w0J8rc1m8/nmRTK5kH3LGCfgQurQIFGibLV+Nqm4shU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-68d680d89cf702cc67c2ebb0b261548622d05ce3.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Main.cxx'>
            ...
            <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/kompote/ManateeX/blob/master/src/sandbox/ben/cases/Main.cxx" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v15:2786772:kompote/ManateeX:b82c92e1bfeca8fb3f5f852bc6f587c8c8c73500:35f132a562911963b802d81d2838d250 -->
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/sandbox/ben/cases/Main.cxx/">
      ...
      <param NAME="FlashVars" value="id=clippy_974&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1315937721?v5"
             ...
             FlashVars="id=clippy_974&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/sandbox/ben/cases/Main.cxx/" data-permalink-url="/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Main.cxx" data-title="src/sandbox/ben/cases/Main.cxx at master from kompote/ManateeX - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/kompote/ManateeX/edit/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/cases/Main.cxx" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/kompote/ManateeX/raw/master/src/sandbox/ben/cases/Main.cxx" id="raw-url">raw</a></li>
                  <li><a href="/kompote/ManateeX/blame/master/src/sandbox/ben/cases/Main.cxx">blame</a></li>
                <li><a href="/kompote/ManateeX/commits/master/src/sandbox/ben/cases/Main.cxx" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L36" rel="#L36">36</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#include &lt;SFML/Graphics.hpp&gt;</span></div><div class='line' id='LC2'><span class="cp">#include &lt;SFML/Window.hpp&gt;</span></div><div class='line' id='LC3'><span class="cp">#include &lt;iostream&gt;</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="cp">#include &quot;Map.hxx&quot;</span></div><div class='line' id='LC6'><span class="k">using</span> <span class="k">namespace</span> <span class="n">sf</span><span class="p">;</span></div><div class='line' id='LC7'><span class="kt">int</span> <span class="n">main</span> <span class="p">(</span><span class="kt">void</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>	<span class="n">Map</span> <span class="n">m</span><span class="p">;</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>	<span class="n">RenderWindow</span> <span class="n">window</span><span class="p">(</span><span class="n">VideoMode</span><span class="p">(</span><span class="mi">800</span><span class="p">,</span> <span class="mi">600</span><span class="p">),</span> <span class="s">&quot;SFML window&quot;</span><span class="p">);</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'>	<span class="c1">//Affichage Map</span></div><div class='line' id='LC14'>	<span class="k">for</span><span class="p">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">=</span><span class="mi">0</span><span class="p">;</span><span class="n">i</span><span class="o">&lt;</span><span class="mi">60</span><span class="p">;</span><span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC15'>		<span class="k">for</span><span class="p">(</span><span class="kt">int</span> <span class="n">j</span><span class="o">=</span><span class="mi">0</span><span class="p">;</span><span class="n">j</span><span class="o">&lt;</span><span class="mi">80</span><span class="p">;</span><span class="n">j</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC16'>			<span class="c1">//std::cout&lt;&lt;&quot;[&quot;&lt;&lt;i&lt;&lt;&quot;;&quot;&lt;&lt;j&lt;&lt;&quot;]&quot;&lt;&lt;endl;</span></div><div class='line' id='LC17'>			<span class="n">Texture</span> <span class="n">terrain</span><span class="p">;</span></div><div class='line' id='LC18'>			<span class="n">terrain</span><span class="p">.</span><span class="n">LoadFromFile</span><span class="p">(</span><span class="n">m</span><span class="p">.</span><span class="n">getCase</span><span class="p">(</span><span class="n">j</span><span class="p">,</span><span class="n">i</span><span class="p">).</span><span class="n">getTexturePath</span><span class="p">());</span></div><div class='line' id='LC19'>			<span class="n">Sprite</span> <span class="n">caseSprite</span><span class="p">(</span><span class="n">terrain</span><span class="p">);</span></div><div class='line' id='LC20'>			<span class="n">caseSprite</span><span class="p">.</span><span class="n">SetPosition</span><span class="p">(</span><span class="n">j</span><span class="o">*</span><span class="mi">10</span><span class="p">,</span><span class="n">i</span><span class="o">*</span><span class="mi">10</span><span class="p">);</span></div><div class='line' id='LC21'>			<span class="n">window</span><span class="p">.</span><span class="n">Draw</span><span class="p">(</span><span class="n">caseSprite</span><span class="p">);</span></div><div class='line' id='LC22'>		<span class="p">}</span></div><div class='line' id='LC23'>	<span class="p">}</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'>	<span class="k">while</span><span class="p">(</span><span class="n">window</span><span class="o">-&gt;</span><span class="n">IsOpened</span><span class="p">())</span> <span class="p">{</span></div><div class='line' id='LC26'>		<span class="n">Event</span> <span class="n">event</span><span class="p">;</span></div><div class='line' id='LC27'>		<span class="k">while</span> <span class="p">(</span><span class="n">window</span><span class="o">-&gt;</span><span class="n">PollEvent</span><span class="p">(</span><span class="n">event</span><span class="p">))</span> <span class="p">{</span></div><div class='line' id='LC28'>	  		<span class="c1">// Window closed</span></div><div class='line' id='LC29'>	  		<span class="k">if</span> <span class="p">(</span><span class="n">event</span><span class="p">.</span><span class="n">Type</span> <span class="o">==</span> <span class="n">Event</span><span class="o">::</span><span class="n">Closed</span><span class="p">)</span> <span class="n">window</span><span class="o">-&gt;</span><span class="n">Close</span><span class="p">();</span></div><div class='line' id='LC30'>		<span class="p">}</span></div><div class='line' id='LC31'><br/></div><div class='line' id='LC32'>		<span class="n">usleep</span><span class="p">(</span><span class="mi">10000</span><span class="p">);</span></div><div class='line' id='LC33'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		<span class="c1">// Update the window</span></div><div class='line' id='LC34'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		<span class="n">window</span><span class="o">-&gt;</span><span class="n">Display</span><span class="p">();</span></div><div class='line' id='LC35'>	<span class="p">}</span></div><div class='line' id='LC36'><span class="p">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.16791s from fe12.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
