...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>src/sandbox/ben/menus/Main.cxx at master from kompote/ManateeX - GitHub</title>
...
<meta content="w0J8rc1m8/nmRTK5kH3LGCfgQurQIFGibLV+Nqm4shU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-68d680d89cf702cc67c2ebb0b261548622d05ce3.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/Main.cxx'>
            ...
            <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/kompote/ManateeX/blob/master/src/sandbox/ben/menus/Main.cxx" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v15:2786772:kompote/ManateeX:b6cfa37f27f527cf496b983bd9a587e158b50b50:3a49bac7abce36ea7fe14a2e9410b562 -->
  <div id="slider">

    <div class="breadcrumb" data-path="src/sandbox/ben/menus/Main.cxx/">
      <b><a href="/kompote/ManateeX/tree/9d5103cccaf06d3640efd15a9048721850babb4a" class="js-rewrite-sha">ManateeX</a></b> / <a href="/kompote/ManateeX/tree/9d5103cccaf06d3640efd15a9048721850babb4a/src" class="js-rewrite-sha">src</a> / <a href="/kompote/ManateeX/tree/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox" class="js-rewrite-sha">sandbox</a> / <a href="/kompote/ManateeX/tree/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben" class="js-rewrite-sha">ben</a> / <a href="/kompote/ManateeX/tree/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus" class="js-rewrite-sha">menus</a> / Main.cxx       <span style="display:none" id="clippy_4035" class="clippy-text">src/sandbox/ben/menus/Main.cxx</span>
      ...
      <param NAME="FlashVars" value="id=clippy_4035&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1315937721?v5"
             ...
             FlashVars="id=clippy_4035&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/sandbox/ben/menus/Main.cxx/" data-permalink-url="/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/Main.cxx" data-title="src/sandbox/ben/menus/Main.cxx at master from kompote/ManateeX - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/kompote/ManateeX/edit/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/Main.cxx" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  <span>35 lines (23 sloc)</span>
                <span>0.569 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/kompote/ManateeX/raw/master/src/sandbox/ben/menus/Main.cxx" id="raw-url">raw</a></li>
                  <li><a href="/kompote/ManateeX/blame/master/src/sandbox/ben/menus/Main.cxx">blame</a></li>
                <li><a href="/kompote/ManateeX/commits/master/src/sandbox/ben/menus/Main.cxx" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L34" rel="#L34">34</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#include &lt;SFML/Graphics.hpp&gt;</span></div><div class='line' id='LC2'><span class="cp">#include &lt;SFML/Window.hpp&gt;</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="cp">#include &quot;MainMenu.hxx&quot;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="k">using</span> <span class="k">namespace</span> <span class="n">sf</span><span class="p">;</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="kt">int</span> <span class="n">main</span><span class="p">(</span><span class="kt">void</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">RenderWindow</span> <span class="n">window</span><span class="p">(</span><span class="n">VideoMode</span><span class="p">(</span><span class="mi">800</span><span class="p">,</span> <span class="mi">600</span><span class="p">),</span> <span class="s">&quot;ManateeX Project&quot;</span><span class="p">);</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">MainMenu</span> <span class="n">menuPrincipal</span><span class="p">;</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">while</span><span class="p">(</span><span class="n">window</span><span class="p">.</span><span class="n">IsOpened</span><span class="p">())</span> <span class="p">{</span></div><div class='line' id='LC17'>	<span class="n">Event</span> <span class="n">event</span><span class="p">;</span></div><div class='line' id='LC18'>	<span class="k">while</span> <span class="p">(</span><span class="n">window</span><span class="p">.</span><span class="n">PollEvent</span><span class="p">(</span><span class="n">event</span><span class="p">))</span> <span class="p">{</span></div><div class='line' id='LC19'>	  	<span class="c1">// Window closed</span></div><div class='line' id='LC20'>	  	<span class="k">if</span> <span class="p">(</span><span class="n">event</span><span class="p">.</span><span class="n">Type</span> <span class="o">==</span> <span class="n">Event</span><span class="o">::</span><span class="n">Closed</span><span class="p">)</span> <span class="n">window</span><span class="p">.</span><span class="n">Close</span><span class="p">();</span></div><div class='line' id='LC21'>	<span class="p">}</span></div><div class='line' id='LC22'>	<span class="n">usleep</span><span class="p">(</span><span class="mi">10000</span><span class="p">);</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<span class="c1">// Update the window</span></div><div class='line' id='LC24'>		<span class="n">window</span><span class="p">.</span><span class="n">Clear</span><span class="p">();</span></div><div class='line' id='LC25'>		<span class="n">menuPrincipal</span><span class="p">.</span><span class="n">Affiche</span><span class="p">(</span><span class="n">window</span><span class="p">);</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<span class="n">window</span><span class="p">.</span><span class="n">Display</span><span class="p">();</span></div><div class='line' id='LC27'>	<span class="p">}</span></div><div class='line' id='LC28'><br/></div><div class='line' id='LC29'>	<span class="n">window</span><span class="p">.</span><span class="n">Clear</span><span class="p">();</span></div><div class='line' id='LC30'>	<span class="n">window</span><span class="p">.</span><span class="n">Close</span><span class="p">();</span></div><div class='line' id='LC31'><br/></div><div class='line' id='LC32'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="p">(</span><span class="n">EXIT_SUCCESS</span><span class="p">);</span></div><div class='line' id='LC33'><span class="p">}</span></div><div class='line' id='LC34'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.11203s from fe12.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
