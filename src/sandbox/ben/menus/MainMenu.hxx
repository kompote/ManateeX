...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>src/sandbox/ben/menus/MainMenu.hxx at master from kompote/ManateeX - GitHub</title>
...
<meta content="w0J8rc1m8/nmRTK5kH3LGCfgQurQIFGibLV+Nqm4shU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-68d680d89cf702cc67c2ebb0b261548622d05ce3.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/MainMenu.hxx'>
            ...
            <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/kompote/ManateeX/blob/master/src/sandbox/ben/menus/MainMenu.hxx" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v15:2786772:kompote/ManateeX:fac780a22f08efe11f78cb43172bd8ccabfc2c7d:0944fec17eeb0ee5e14e48b235a5bb41 -->
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/sandbox/ben/menus/MainMenu.hxx/">
      ...
      <param NAME="FlashVars" value="id=clippy_4480&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1315928456?v5"
             ...
             FlashVars="id=clippy_4480&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/sandbox/ben/menus/MainMenu.hxx/" data-permalink-url="/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/MainMenu.hxx" data-title="src/sandbox/ben/menus/MainMenu.hxx at master from kompote/ManateeX - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/kompote/ManateeX/edit/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/MainMenu.hxx" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/kompote/ManateeX/raw/master/src/sandbox/ben/menus/MainMenu.hxx" id="raw-url">raw</a></li>
                  <li><a href="/kompote/ManateeX/blame/master/src/sandbox/ben/menus/MainMenu.hxx">blame</a></li>
                <li><a href="/kompote/ManateeX/commits/master/src/sandbox/ben/menus/MainMenu.hxx" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L21" rel="#L21">21</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#ifndef _MAINMENU_HXX</span></div><div class='line' id='LC2'><span class="cp">#define	_MAINMENU_HXX</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="cp">#include&lt;SFML/Graphics.hpp&gt;</span></div><div class='line' id='LC5'><span class="cp">#include&lt;SFML/Window.hpp&gt;</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="k">using</span> <span class="k">namespace</span> <span class="n">sf</span><span class="p">;</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="k">class</span> <span class="nc">MainMenu</span> <span class="p">{</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'><span class="k">private</span> <span class="o">:</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">Sprite</span> <span class="n">background</span><span class="p">;</span></div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">Texture</span> <span class="n">imgfond</span><span class="p">;</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><span class="k">public</span> <span class="o">:</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">MainMenu</span><span class="p">();</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kt">void</span> <span class="n">Affiche</span><span class="p">(</span><span class="n">RenderTarget</span><span class="o">&amp;</span> <span class="n">target</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span></div><div class='line' id='LC18'><span class="p">};</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="cp">#endif</span></div><div class='line' id='LC21'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.13905s from fe11.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
