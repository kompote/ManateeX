...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>src/sandbox/ben/menus/MainMenu.cxx at master from kompote/ManateeX - GitHub</title>
...
<meta content="w0J8rc1m8/nmRTK5kH3LGCfgQurQIFGibLV+Nqm4shU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-68d680d89cf702cc67c2ebb0b261548622d05ce3.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/MainMenu.cxx'>
            ...
            <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/kompote/ManateeX/blob/master/src/sandbox/ben/menus/MainMenu.cxx" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v15:2786772:kompote/ManateeX:2794131d75e8a202fe53ab68deba8b7f2e8bde36:48bb65755c9abc5c19d2aaa91410652d -->
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/sandbox/ben/menus/MainMenu.cxx/">
      ...
      <param NAME="FlashVars" value="id=clippy_3924&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1315928456?v5"
             ...
             FlashVars="id=clippy_3924&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/sandbox/ben/menus/MainMenu.cxx/" data-permalink-url="/kompote/ManateeX/blob/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/MainMenu.cxx" data-title="src/sandbox/ben/menus/MainMenu.cxx at master from kompote/ManateeX - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/kompote/ManateeX/edit/9d5103cccaf06d3640efd15a9048721850babb4a/src/sandbox/ben/menus/MainMenu.cxx" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/kompote/ManateeX/raw/master/src/sandbox/ben/menus/MainMenu.cxx" id="raw-url">raw</a></li>
                  <li><a href="/kompote/ManateeX/blame/master/src/sandbox/ben/menus/MainMenu.cxx">blame</a></li>
                <li><a href="/kompote/ManateeX/commits/master/src/sandbox/ben/menus/MainMenu.cxx" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L12" rel="#L12">12</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#include &quot;MainMenu.hxx&quot;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="n">MainMenu</span><span class="o">::</span><span class="n">MainMenu</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC4'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">imgfond</span><span class="p">.</span><span class="n">LoadFromFile</span><span class="p">(</span><span class="s">&quot;fondmenu.png&quot;</span><span class="p">);</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">background</span><span class="p">.</span><span class="n">SetTexture</span><span class="p">(</span><span class="n">imgfond</span><span class="p">);</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">background</span><span class="p">.</span><span class="n">SetPosition</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span><span class="mi">0</span><span class="p">);</span></div><div class='line' id='LC8'><span class="p">}</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><span class="kt">void</span> <span class="n">MainMenu</span><span class="o">::</span><span class="n">Affiche</span><span class="p">(</span><span class="n">RenderTarget</span><span class="o">&amp;</span> <span class="n">target</span><span class="p">)</span> <span class="k">const</span> <span class="p">{</span></div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">target</span><span class="p">.</span><span class="n">Draw</span><span class="p">(</span><span class="n">background</span><span class="p">);</span>  </div><div class='line' id='LC12'><span class="p">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.07831s from fe12.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
